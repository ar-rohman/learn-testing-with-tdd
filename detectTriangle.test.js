 ...
 *    - should throw eror when input is not a positive number
 *    - should throw error when input is triangle inequality violation 
 *    - sholud return "Segitiga Sama Sisis" when all input are equal
 *    - sholud return "Segitiga Sama Kaki" when two input are equal
 *    - sholud return "Segitiga Sama Sembarang" when all input are different
 */
...
describe('detectTriangle function', () => {
  ...
  it('should throw error when input is triangle inequity violation', () => {
  ...
  it('should return "Segitiga Sama Sembarang" when all input are different', () => {
    expect(detectTriangle(2, 3, 4)).toBe('Segitiga Sama Sembarang');
    expect(detectTriangle(5, 6, 7)).toBe('Segitiga Sama Sembarang');
    expect(detectTriangle(8, 9, 10)).toBe('Segitiga Sama Sembarang');
  })
})